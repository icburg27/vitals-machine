"""Compute the vitals from the panel: dimension, mean rho, MST, separation, vorticity,
frontier scores, cluster births, pair ratio, VIX. Appends/updates data/metrics.csv,
...
def main():
    ...
    # frontier scores (last 60d) for watch + pocket
